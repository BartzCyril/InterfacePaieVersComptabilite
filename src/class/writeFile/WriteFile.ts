...
export class writeFile {
    ...
    */
    private static generateFile(company: Company, year: string, informationsMonth: { numberMonth: string, endOfMonth: string }, data: {account: string[], creditDebit: string[], firstSection: string[], secondSection: string[], codeH: boolean[]}): string {
        // Première ligne du document "00"
        let str: string = "00 " + company.getCodeFile() + "        " + year + " " + informationsMonth.numberMonth + " S\n"
        let k: number = 0
    ...
    */
    private static getLinesStartingWith01And02(index: number, year: string, informationsMonth: { numberMonth: string, endOfMonth: string }, data: {account: string[], creditDebit: string[], firstSection: string[], secondSection: string[], codeH: boolean[]}): string {
        let str: string = ""
        let code: string = ""
    ...
    */
    static downloadFile(company: Company, year: string, informationsMonth: { numberMonth: string, endOfMonth: string }, data: {account: string[], creditDebit: string[], firstSection: string[], secondSection: string[], codeH: boolean[]}): void {
