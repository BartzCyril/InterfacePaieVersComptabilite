export class Data {
    ...
    private regexAccount: RegExp = new RegExp('[4-7][0-9][0-9][0-9][0-9]')
    private regexCodeH: RegExp = new RegExp(';;;[0-9][0-9 ]*,[0-9]*;;')
    private regexCreditDebit: RegExp = new RegExp('(;;;;[0-9][0-9 ]*,[0-9]*;)|(;;;;[0-9 ]+;)|(;;;[0-9][0-9 ]*,[0-9]*;;)')
    private regexSection: RegExp = new RegExp(';[0-9]*;((-?[0-9 ]+,[0-9]+)|([0-9]*));-?[0-9 ]*,[0-9]*;;;')
    private lineFile: string[]

    constructor(lineFile: string[]) {
    ...
    */
    getData(): object {
        let account: string[] = []
        let creditDebit: string[] = []
        let firstSection: string[] = []
        let secondSection: string[] = []
        let codeH: boolean[] = []
        let isMatchRegexSection: boolean = false
        this.lineFile.forEach(element => {
            ...
            if (matchAccount) {
                ...
                if (matchRegexSection) {
                    this.getDataFirstSection(matchRegexSection[0]) ? firstSection.push(this.getDataFirstSection(matchRegexSection[0]) as string) : null
                    this.getDataSecondSection(matchRegexSection[0]) ? secondSection.push(this.getDataSecondSection(matchRegexSection[0]) as string) : null
    ...
    */
    private getDataFirstSection(str: string): string | null {
    ...
    */
    private getDataSecondSection(str: string): string | null {
